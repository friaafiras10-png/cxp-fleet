...
export default function Home() {
  ...
  async function handleLogin(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!userSnap.exists()) { setMessage("Nous n'avons pas retrouvé votre profil."); return; }
      const userData = userSnap.data();
      if (userData.role === "admin") { router.push("/admin"); return; }
      if (userData.role === "worker") { router.push("/worker"); return; }
      setMessage("Votre rôle n'est pas reconnu.");
    } catch (error) {
      if (error instanceof FirebaseError) {
        switch (error.code) {
          case "auth/invalid-email": setMessage("Cette adresse email ne semble pas valide."); break;
          case "auth/user-not-found":
          case "auth/wrong-password":
          case "auth/invalid-credential": setMessage("Email ou mot de passe incorrect. Réessayez."); break;
          default: setMessage(`Une erreur est survenue : ${error.code}`);
        }
      } else { setMessage("Quelque chose a mal tourné. Réessayez."); }
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      <style>{`
        ...
        /* PURPLE-DOMINANT gradient border */
        .glass-shell {
          position: relative;
          border-radius: 32px;
          padding: 1.5px;
        ...
        /* Logo tile — purple → pink gradient */
        .logo-tile {
          position: relative;
          ...
          <div className="glass-shell">
            <div className="glass-inner">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-baseline gap-2 flex-wrap">
                    ...
                    <span style={{
                      ...
                      La livraison <span style={{ color: "#a02a92", fontWeight: 500 }}>qui tient parole</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p className="a3 text-[13.5px] text-[#6a3a78] leading-[1.6] mb-7 relative">
                Connectez-vous à votre poste de pilotage pour suivre la flotte, vos équipes et vos tournées — en temps réel.
              </p>
